...
func getBalanceSchema() *api.CollectionSchema {
	...
	return &api.CollectionSchema{
		...
		Fields: []api.Field{
			...
			{Name: "ledger_id", Type: "string", Reference: "identities.identity_id", Facet: &facet},
...
func getTransactionSchema() *api.CollectionSchema {
	...
	return &api.CollectionSchema{
		...
		Fields: []api.Field{
			...
			{Name: "source", Type: "string", Reference: "balances.balance_id", Facet: &facet},
			{Name: "destination", Type: "string", Reference: "balances.balance_id", Facet: &facet},
