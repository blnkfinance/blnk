...
type transaction interface {
	...
	GetAllTransactions(cxt context.Context) ([]model.Transaction, error) // Retrieves all transactions
...
type ledger interface {
	...
	GetAllLedgers() ([]model.Ledger, error) // Retrieves all ledgers
...
type balance interface {
	...
	GetAllBalances() ([]model.Balance, error) // Retrieves all balances
